...
float HSM_USE_PLACEMENT_IMAGE_SCREEN_SCALE_AND_POS;
...
float HSM_BZL_INNER_CURVATURE_SCALE;
	float HSM_BZL_USE_INDEPENDENT_SCALE_AND_CURVATURE;
	...
	float HSM_REFLECT_PASS_IMG_OPACITY;
	float HSM_REFLECT_PASS_IMG_BLEND_MODE;
	float HSM_REFLECT_PASS_IMG_ASPECT_RATIO;
	float HSM_REFLECT_PASS_IMG_SHOW_OVER_SCREEN;
