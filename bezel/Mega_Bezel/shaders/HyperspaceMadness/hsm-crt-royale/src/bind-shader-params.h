...
float HSM_INTRO_IMAGE_BLEND_MODE;
float HSM_INTRO_IMAGE_RES_X;
float HSM_INTRO_IMAGE_RES_Y;
float HSM_INTRO_IMAGE_TIME_INITIAL_WAIT;
float HSM_INTRO_IMAGE_TIME_FADE_IN;
float HSM_INTRO_IMAGE_TIME_HOLD;
float HSM_INTRO_IMAGE_TIME_FADE_OUT;
