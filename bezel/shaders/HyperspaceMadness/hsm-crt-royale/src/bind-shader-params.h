...
float H_SPLIT_SCREEN_AMOUNT;
	...
	float H_POSITION_OFFSET_X;
	float H_POSITION_OFFSET_Y;
	...
	float H_BZL_OUTER_POS_Y_OFFSET;
...
float H_REFLECTION_IS_LAST_PASS;
	...
	// Image Background
	float H_BG_IMG_BRIGHTNESS;
	float H_BG_IMG_VIGNETTE_OPACITY;
	float H_BG_IMG_APPLY_ADJUSTMENT;
float H_BG_IMG_MASK_MODE;
	float H_BG_IMG_SCALE_MODE;
	float H_BG_IMG_SCALE_KEEP_ASPECT;
	float H_BG_IMG_SCALE;
	float H_BG_IMG_SCALE_X;
	float H_BG_IMG_POS_Y;
	float H_BG_IMG_MIRROR_WRAP;

	// CRT Screen
	float H_CRT_SCREEN_BLEND_MODE;

	// Tube Reflection
	float H_CAB_GLS_OPACITY;
float H_CAB_GLS_BRIGHTNESS;
	float H_CAB_GLS_BLEND_MODE;
	float H_CAB_GLS_MASK_MODE;
float H_CAB_GLS_CUTOUT_MODE;
	float H_CAB_GLS_DEPTH_ORDER;
	float H_CAB_GLS_SCALE_MODE;
	float H_CAB_GLS_SCALE_KEEP_ASPECT;
	float H_CAB_GLS_SCALE;
	float H_CAB_GLS_SCALE_X;
	float H_CAB_GLS_POS_Y;
...
float H_IMG_CUTOUT_WIDTH;
float H_IMG_CUTOUT_HEIGHT;
float H_IMG_CUTOUT_CORNER_RADIUS;
	...
	// Night Lighting
	float H_NLIGHT_IMG_OPACITY;
	float H_NLIGHT_IMG_MIRROR_HORZ;
	float H_NLIGHT_IMG_MIRROR_VERT;
	float H_NLIGHT_IMG_SATURATION;
	float H_NLIGHT_IMG_HUE;
	float H_NLIGHT_IMG_VALUE;
	float H_NLIGHT_IMG_DITHERING_SAMPLES;
