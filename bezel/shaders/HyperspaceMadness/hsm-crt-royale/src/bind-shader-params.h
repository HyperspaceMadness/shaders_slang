...
float HSS_SPLIT_SCREEN_AMOUNT;
	...
	float HSS_SCREEN_CORNER_RADIUS;
	float HSS_SCREEN_EDGE_SHARPNESS;
	float HSS_SCREENFX_VIGNETTE;
	float HSS_SCREENFX_FAKE_SCANLINE_OPACITY;
	float HSS_SCREENFX_FAKE_SCANLINE_BRIGHTNESS_CUTOFF;
	float HSS_TUBE_COLORED_GEL_IMAGE_MULTIPLY_AMOUNT;
	float HSS_TUBE_COLORED_GEL_IMAGE_ADDITIVE_AMOUNT;
	float HSS_TUBE_HIGHLIGHT_IMAGE_OPACITY;
	float HSS_TUBE_HIGHLIGHT_IMAGE_SCALE;
	float HSS_TUBE_HIGHLIGHT_IMAGE_DITHERING_SAMPLES;
	...
	float HBZ_BEZEL_OUTER_CURVATURE_SCALE;
	...
	float HBZ_BEZEL_OUTER_POS_Y_OFFSET;
...
float HBR_REFLECTION_IS_LAST_PASS;
	...
	// Image Background
	float HLY_BG_IMAGE_BRIGHTNESS;
	float HLY_BG_IMAGE_VIGNETTE_OPACITY;
	float HLY_BG_IMAGE_APPLY_NIGHT_LIGHTING_AND_STATIC_GAMMA;
float HLY_BG_IMAGE_MASK_MODE;
	float HLY_BG_IMAGE_SCALE_MODE;
	float HLY_BG_IMAGE_SCALE_KEEP_ASPECT;
	float HLY_BG_IMAGE_SCALE;
	float HLY_BG_IMAGE_SCALE_X;
	float HLY_BG_IMAGE_POS_Y;
	float HLY_BG_IMAGE_MIRROR_WRAP;

	// CRT Screen
	float HLY_CRT_SCREEN_BLEND_MODE;

	// Tube Reflection
	float HLY_CABINET_GLASS_IMAGE_OPACITY;
float HLY_CABINET_GLASS_IMAGE_BRIGHTNESS;
	float HLY_CABINET_GLASS_IMAGE_BLEND_MODE;
	float HLY_CABINET_GLASS_IMAGE_MASK_MODE;
float HLY_CABINET_GLASS_IMAGE_CUTOUT_MODE;
	float HLY_CABINET_GLASS_IMAGE_DEPTH_ORDER;
	float HLY_CABINET_GLASS_IMAGE_SCALE_MODE;
	float HLY_CABINET_GLASS_IMAGE_SCALE_KEEP_ASPECT;
	float HLY_CABINET_GLASS_IMAGE_SCALE;
	float HLY_CABINET_GLASS_IMAGE_SCALE_X;
	float HLY_CABINET_GLASS_IMAGE_POS_Y;
	float HBZ_BEZEL_INNER_EDGE_SHADOW;


	// Image Bezel
	float HLY_BEZEL_IMAGE_OPACITY;
	float HLY_BEZEL_IMAGE_HUE;
float HLY_BEZEL_IMAGE_SATURATION;
float HLY_BEZEL_IMAGE_BRIGHTNESS;
	float HLY_BEZEL_IMAGE_MASK_MODE;
	float HLY_BEZEL_IMAGE_DEPTH_ORDER;
	float HLY_BEZEL_IMAGE_SCALE_MODE;
	float HLY_BEZEL_IMAGE_SCALE_KEEP_ASPECT;
	float HLY_BEZEL_IMAGE_SCALE;
	float HLY_BEZEL_IMAGE_SCALE_X;
	float HLY_BEZEL_IMAGE_POS_Y;
float HLY_BEZEL_IMAGE_USE_CURVATURE;


	// Generated Bezel & Frame
	float HLY_BEZEL_OPACITY;
	float HLY_BEZEL_BLEND_MODE;
	float HLY_FRAME_OPACITY;
	float HLY_FRAME_BLEND_MODE;

	// Reflection
	float HLY_REFLECTION_MASK_MODE;
float HLY_IMAGE_CUTOUT_WIDTH;
float HLY_IMAGE_CUTOUT_HEIGHT;
float HLY_IMAGE_CUTOUT_CORNER_RADIUS;
	float HLY_REFLECTION_BLEND_MODE;

	// Decal
	float HLY_DECAL_IMAGE_OPACITY;
	float HLY_DECAL_IMAGE_BLEND_MODE;
	float HLY_DECAL_IMAGE_MASK_MODE;
	float HLY_DECAL_IMAGE_SCALE_MODE;
	float HLY_DECAL_IMAGE_SCALE_KEEP_ASPECT;
	float HLY_DECAL_IMAGE_SCALE;
	float HLY_DECAL_IMAGE_SCALE_X;
	float HLY_DECAL_IMAGE_POS_Y;
	
	// Night Lighting
	float HLY_NIGHTLIGHTING_IMAGE_OPACITY;
	float HLY_NIGHTLIGHTING_IMAGE_MIRROR_HORZ;
	float HLY_NIGHTLIGHTING_IMAGE_MIRROR_VERT;
	float HLY_NIGHTLIGHTING_IMAGE_SATURATION;
	float HLY_NIGHTLIGHTING_IMAGE_HUE;
	float HLY_NIGHTLIGHTING_IMAGE_VALUE;
	float HLY_NIGHTLIGHTING_IMAGE_DITHERING_SAMPLES;

	// LED
	float HLY_LED_IMAGE_OPACITY;
	float HLY_LED_IMAGE_BLEND_MODE;
	float HLY_LED_IMAGE_MASK_MODE;
	float HLY_LED_IMAGE_SCALE_MODE;

	// Top Image
	float HLY_TOP_IMAGE_OPACITY;
	float HLY_TOP_IMAGE_BLEND_MODE;
	float HLY_TOP_IMAGE_MASK_MODE;
	float HLY_TOP_IMAGE_CUTOUT_MODE;
	float HLY_TOP_IMAGE_DEPTH_ORDER;
	float HLY_TOP_IMAGE_SCALE_MODE;
	float HLY_TOP_IMAGE_SCALE_KEEP_ASPECT;
	float HLY_TOP_IMAGE_SCALE;
	float HLY_TOP_IMAGE_SCALE_X;
	float HLY_TOP_IMAGE_POS_Y;	
	float HLY_TOP_IMAGE_MIRROR_WRAP;

	float HLY_STATIC_LAYERS_GAMMA;
