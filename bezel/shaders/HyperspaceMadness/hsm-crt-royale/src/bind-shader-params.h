...
layout(std140, set = 0, binding = 0) uniform UBO
{
	...
	float HSM_FLIP_VIEWPORT_AND_CORE_VERTICAL;
...
float HSM_SPLITSCREEN_AMOUNT;
	...
	float HSM_PHOSPHOR_PERSISTENCE;
...
float HSM_CRT_IS_LAST_PASS;
	...
	float HSM_TUBE_HIGHLIGHT_IMAGE_OPACITY;
	float HSM_TUBE_HIGHLIGHT_IMAGE_SCALE;
	float HSM_TUBE_HIGHLIGHT_IMAGE_DITHERING_SAMPLES;
	...
	float HSM_BZL_COLOR_BLEND_WITH_IMAGE;
	...
	float HSM_REFLECT_INNER_EDGE_AMOUNT;
	float HSM_REFLECT_INNER_EDGE_FULLSCREEN_GLOW;
