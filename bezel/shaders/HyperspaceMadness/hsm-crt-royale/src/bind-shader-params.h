...
float HSS_SPLIT_SCREEN_CENTER_FILL_MODE;
	...
	float HBZ_IMAGE_LAYER_HORZ_VIEWPORT_TUBE_HEIGHT;
	float HBZ_BACKGROUND_IMAGE_BRIGHTNESS;
float HBZ_BACKGROUND_IMAGE_VIGNETTE_OPACITY;
float HBZ_BACKGROUND_IMAGE_USE_AS_BACKGROUND;
float HBZ_BACKGROUND_IMAGE_SCALE_WITH_TUBE;
float HBZ_BACKGROUND_IMAGE_SCALE;
float HBZ_BACKGROUND_IMAGE_POS_Y;
float HBZ_BEZEL_IMAGE_ON;
float HBZ_BEZEL_IMAGE_SCALE_WITH_TUBE;
float HBZ_BEZEL_IMAGE_SCALE;
float HBZ_BEZEL_IMAGE_POS_Y;
...
float HBR_CORNER_ROTATION_OFFSET_BOTTOM;
	...
	float HBZ_FRAME_DECAL_IMAGE_OPACITY;
float HBZ_FRAME_DECAL_IMAGE_SCALE;
float HBZ_FRAME_DECAL_IMAGE_POS_Y;
float HBZ_NIGHTLIGHTING_IMAGE_OPACITY;
float HBZ_LED_IMAGE_OPACITY;
