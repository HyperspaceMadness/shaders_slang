...
layout(std140, set = 0, binding = 0) uniform UBO
{
	...
	float H_SCANLINE_INTERLACE_TRIGGER_RES;

	float H_SPLITSCREEN_ON;
float H_SPLITSCREEN_AMOUNT;
	float H_SPLITSCREEN_CENTER_FILL_MODE;
...
float H_CRT_IS_LAST_PASS;
	float H_SCREENFX_VIGNETTE;
	float H_SCANLINE_FAKE_SCANLINE_OPACITY;
	float H_SCANLINE_FAKE_SCANLINE_BRIGHTNESS_CUTOFF;
	...
	float H_BZL_INNER_CURVATURE_SCALE;
	...
	// Blur Stuff
	float H_REFLECT_BLUR_NUM_SAMPLES;
	float H_REFLECT_BLUR_MIN;
	float H_REFLECT_BLUR_MAX;

	// Reflection
	float H_REFLECT_GLOBAL_AMOUNT;
	float H_REFLECT_GLOBAL_GAMMA_ADJUST;

	float H_REFLECT_INNER_EDGE_AMOUNT;
	float H_REFLECT_INNER_EDGE_FULLSCREEN_GLOW;
	float H_REFLECT_DIRECT_AMOUNT;
	float H_REFLECT_DIFFUSED_AMOUNT;
	float H_REFLECT_FULLSCREEN_GLOW;
	float H_REFLECT_FULLSCREEN_GLOW_GAMMA;

	float H_REFLECT_FADE_AMOUNT;
	float H_REFLECT_RADIAL_FADE_WIDTH;
	float H_REFLECT_RADIAL_FADE_HEIGHT;

	float H_REFLECT_LATERAL_OUTER_FADE_POSITION;
	float H_REFLECT_LATERAL_OUTER_FADE_DISTANCE;

	float H_REFLECT_CORNER_FADE;
	float H_REFLECT_CORNER_INNER_SPREAD;
	float H_REFLECT_CORNER_OUTER_SPREAD;
float H_REFLECTION_IS_LAST_PASS;
	float H_REFLECT_CORNER_ROTATION_OFFSET_TOP;
	float H_REFLECT_CORNER_ROTATION_OFFSET_BOTTOM;
	float H_REFLECT_CORNER_FADE_DISTANCE;

	float H_REFLECT_NOISE_AMOUNT;
	float H_REFLECT_NOISE_SAMPLES;
	float H_REFLECT_NOISE_SAMPLE_DISTANCE;
	float H_REFLECT_CORNER_SPREAD_FALLOFF;

	float H_GLASSBORDER_ON;
...
float H_BG_MASK_MODE;
	float H_BG_TEXTURE_ASPECT_MODE;
float H_BG_EXPLICIT_TEXTURE_ASPECT;
...
float H_CAB_GLASS_CUTOUT_MODE;
	float H_CAB_GLASS_TEXTURE_ASPECT_MODE;
float H_CAB_GLASS_EXPLICIT_TEXTURE_ASPECT;
...
float H_BZL_IMG_CUTOUT_MODE;
	float H_BZL_IMG_TEXTURE_ASPECT_MODE;
float H_BZL_IMG_EXPLICIT_TEXTURE_ASPECT;
...
float H_CUTOUT_POS_Y;
	...
	float H_DECAL_TEXTURE_ASPECT_MODE;
float H_DECAL_EXPLICIT_TEXTURE_ASPECT;
...
float H_DECAL_CUTOUT_MODE;
	...
	float H_LED_TEXTURE_ASPECT_MODE;
float H_LED_EXPLICIT_TEXTURE_ASPECT;
...
float H_LED_POS_Y;
	...
	float H_TOP_TEXTURE_ASPECT_MODE;
float H_TOP_EXPLICIT_TEXTURE_ASPECT;
