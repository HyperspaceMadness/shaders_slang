...
float HSS_SPLIT_SCREEN_AMOUNT;
	...
	float HSS_SCREENFX_GEL_IMAGE_MULTIPLY_AMOUNT;
	float HSS_SCREENFX_GEL_IMAGE_ADDITIVE_AMOUNT;
...
float HLY_BG_IMAGE_MASK_MODE;
	...
	// Tube Reflection
	float HLY_GLASS_IMAGE_OPACITY;
	float HLY_GLASS_IMAGE_BLEND_MODE;
	float HLY_GLASS_IMAGE_MASK_MODE;
	float HLY_GLASS_IMAGE_DEPTH_ORDER;
	float HLY_GLASS_IMAGE_SCALE_MODE;
	float HLY_GLASS_IMAGE_SCALE_KEEP_ASPECT;
	float HLY_GLASS_IMAGE_SCALE;
	float HLY_GLASS_IMAGE_SCALE_X;
	float HLY_GLASS_IMAGE_POS_Y;
	float HLY_GLASS_IMAGE_DITHERING_SAMPLES;
...
float HLY_BEZEL_IMAGE_USE_CURVATURE;
	...
	float HLY_TOP_IMAGE_POS_Y;	float HLY_TOP_IMAGE_DEPTH_ORDER;
	float HLY_TOP_IMAGE_APPLY_NIGHT_LIGHTING;
